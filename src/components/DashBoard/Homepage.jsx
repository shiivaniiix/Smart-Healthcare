...
const Homepage = () => {
  return (
      ...
      <div className="flex flex-grow items-center bg-gray-100 rounded-md px-2 w-4">
        ...
        <button className="text-blue-500">
          <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M21 21l-4.35-4.35m0 0A7.5 7.5 0 1117.5 10.5a7.5 7.5 0 01-4.85 7.15l4.35 4.35z" />
          </svg>
        </button>
      </div>
    ...
    <h1 className="mt-5 text-gray-600 text-2xl font-normal m">Dashboard</h1>
